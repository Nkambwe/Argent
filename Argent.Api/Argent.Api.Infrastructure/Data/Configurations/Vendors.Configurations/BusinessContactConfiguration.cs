...
namespace Argent.Api.Infrastructure.Data.Configurations.Vendors.Configurations {
    public class BusinessContactConfiguration : IEntityTypeConfiguration<BusinessContact> {
        public void Configure(EntityTypeBuilder<BusinessContact> builder) {
            ...
            builder.Property(r => r.ContactPerson).IsRequired().HasMaxLength(250);
            builder.Property(r => r.BusinessTitle).IsRequired().HasMaxLength(250);
            builder.Property(r => r.EmailAddress).IsRequired().HasMaxLength(250);
            builder.Property(r => r.PhoneNumber).IsRequired().HasMaxLength(250);
