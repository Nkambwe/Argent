...
namespace Argent.Api.Infrastructure.Data.Configurations.Kyc.Configurations {
    public class CustomerBaseConfiguration : IEntityTypeConfiguration<CustomerBase> {
        public void Configure(EntityTypeBuilder<CustomerBase> builder) {
            ...
            builder.Property(c => c.PermanentAddress).HasMaxLength(512);
            builder.Property(c => c.MailAddress).HasMaxLength(512);
            builder.Property(c => c.PrimaryLine).HasMaxLength(512);
            builder.Property(c => c.SecondaryLine).HasMaxLength(512);
            builder.Property(c => c.Mobile).HasMaxLength(512);
            builder.Property(c => c.Fax).HasMaxLength(512);
            builder.Property(c => c.Email).HasMaxLength(512);
            builder.Property(c => c.City).HasMaxLength(512);
            builder.Property(c => c.Town).HasMaxLength(512);
            builder.Property(c => c.WhatsApp).HasMaxLength(512);
            builder.Property(c => c.Facebook).HasMaxLength(512);
            builder.Property(c => c.Instagram).HasMaxLength(512);
            builder.Property(c => c.Twitter).HasMaxLength(512);
