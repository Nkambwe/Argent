...
namespace Argent.Api.Infrastructure.Core.Commands.Products {
    public record UpsertPostingAccountCommand(long ProductId, ProductModuleType Module, UpsertPostingAccountRequest Request)
    : IRequest<Result<PostingAccountDto>>, IAuditableCommand {
        public string AuditModule => "Products"; 
        public string AuditAction => "UpsertPostingAccount";
