...
namespace Argent.Api.Infrastructure.Core.Commands.Products {
    public record AddTimedepositTierCommand(long ProductId, CreateTimedepositTierRequest Request)
        : IRequest<Result<TimedepositTierDto>>, IAuditableCommand {
        public string AuditModule => "Products";
        public string AuditAction => "AddTimedepositTier";
        public AuditAction AuditActionType => Domain.Enums.AuditAction.Create;
        public string? AuditEntityName => "TimedepositInterestTier";
    }
}
